      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-0 right-0 w-full md:w-[40vw] h-full bg-white shadow-lg z-[1000] flex flex-col p-10"
          >
            {/* Close Button */}
            <button onClick={toggleMenu} className="self-end text-3xl font-bold">
              &times;
            </button>
            ...
            <div className="mt-10 text-black">
              ...
              <ul className="space-y-4 mt-2 text-xl md:text-2xl font-light">
                {[
                  "What we do",
                  "Projects",
                  "Company",
